...
// non-sandboxed exit codes and the assertion throws. PR 1 ships the per-
// connector contract surface; the harness that lights the suite up is a
// tracked follow-up (Phase 5 T2 PR 1 / Task 19).
