...
const raindropGet = createJsonGetter({
  base: BASE,
  label: "Raindrop",
  headers: envAuthHeaders({ env: "RAINDROP_TOKEN" }),
});
...
export const RAINDROP_TOOL_NAMES = [
  "raindrop_list",
  "raindrop_get",
  "raindrop_search",
...
export function registerRaindropTools(reg: ZodToolRegistrar): void {
  reg(
    "raindrop_list",
