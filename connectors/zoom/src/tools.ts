...
const zoomGet = createJsonGetter({
  base: BASE,
  label: "Zoom",
  headers: envAuthHeaders({ env: "ZOOM_TOKEN" }),
});

/** Tool names exposed by this connector — for contract/introspection tests. */
export const ZOOM_TOOL_NAMES = [
  "zoom_list",
  "zoom_get",
  "zoom_search",
...
export function registerZoomTools(reg: ZodToolRegistrar): void {
  reg(
    "zoom_list",
