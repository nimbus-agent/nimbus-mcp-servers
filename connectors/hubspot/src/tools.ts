...
const hubspotGet = createJsonGetter({
  base: BASE,
  label: "HubSpot",
  headers: envAuthHeaders({ env: "HUBSPOT_TOKEN" }),
});
...
export const HUBSPOT_TOOL_NAMES = ["hubspot_get", "hubspot_list", "hubspot_search"] as const;

export function registerHubspotTools(reg: ZodToolRegistrar): void {
  reg(
    "hubspot_list",
